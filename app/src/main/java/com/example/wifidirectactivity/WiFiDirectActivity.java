...
public class WiFiDirectActivity extends Activity implements ChannelListener,
    ...
    private boolean isWifiPpEnabled = false;
    ...
    /**
     * @param isWifiPpEnabled the isWifiPpEnabled to set
     */
    public void setIsWifiPpEnabled(boolean isWifiPpEnabled) {
        this.isWifiPpEnabled = isWifiPpEnabled;
    }
    ...
    public void connect(WifiP2pConfig config) {
        ...
        manager.connect(channel, config, lisener);
    }
    ...
    public void onChannelDisconnected() {
        ...
        if (manager != null && !retryChannel) {
            ...
            Toast.makeText(
                    this,
                    "Severe! Channel is probably lost premanently. Try Disable/Re-Enable PP.",
                    Toast.LENGTH_LONG
            ).show();
        }
    }
    ...
    public void cancelDisconnect() {
		 ...
		 * already connected. Else, request WifiPpManager to abort the ongoing
		 * request
		 */
        if (manager != null) {
